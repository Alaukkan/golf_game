...
DISTANCE_LEFT_TEXT_POS = (int(UI_RESOLUTION[0] * 0.2), int(UI_RESOLUTION[1] * 0.3))
...
SWINGSPEED_OPTIONS_POS = (int(UI_RESOLUTION[0] * 0.3), int(UI_RESOLUTION[1] * 0.84))

CLUB_TEXT_POS = (int(UI_RESOLUTION[0] * 0.3), int(UI_RESOLUTION[1] * 0.78))
